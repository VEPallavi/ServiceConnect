...
public class ServiceAndProductOrderMenuFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        serviceAndProductOrderMenuAdapter = new ServiceAndProductOrderMenuAdapter(getActivity(), categoryInfoList
                , OrderProductsAndServicesActivity.finalListHashMap, categoryType, currencySymbol);
...
//                String sizePrice = "";
//
//                if(storeItemDetailsListModel.is_size() && !edit || storeItemDetailsListModel.is_size() && !storeItemDetailsListModel.isExtraPackage() ) {
//                    for (int i = 0; i < storeItemDetailsListModel.getSizeDetailsList().size(); i++) {
//                        if (selectedRadioButtonId == i) {
//
//                            storeItemDetailsListModel.getSizeDetailsList().get(i).setSelected(true);
//
//                        } else {
//
//                            storeItemDetailsListModel.getSizeDetailsList().get(i).setSelected(false);
//                        }
//                    }
//                }
//
//                sizePrice = storeItemDetailsListModel.getSizeDetailsList().get(selectedRadioButtonId).getSizePrice();
//
//                if (storeItemDetailsListModel.isExtraPackage()) {
//
...
//                    i.putExtra(AppConstants.STORE_ITEM_DETAILS, strJsonStoreItemDetailsLModel);
//
//                    i.putExtra(AppConstants.ITEM_ID, storeItemDetailsListModel.getStoreCategoriesItemId());
//
...
//            }
    ...
    public void addListToFinalHashMap(StoreItemDetailsListCategoryInfo storeItemDetailsListModel) {
        ...
        setSelectedItemCountandPrice();

    }

    private void setSelectedItemCountandPrice() {
        ...
        if (totalSelectedCount == 0) {
            ...
            OrderProductsAndServicesActivity.tv_product_item_count.setText("No item selected");
